...
//		
		...
		spider.thread(1);
		spider.getSite().setRetryTimes(3).setSleepTime(1000).setUseGzip(true).setCharset("UTF-8").setUserAgent("Chrome");
		//setUserAgent("Opera/9.80 (Windows NT 6.1; U; en) Presto/2.2.15 Version/10.00");
